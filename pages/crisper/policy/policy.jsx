function policy() {
	return (
		<div>
			...
			<br />
			<br />
			Junaid Gandhi (Eclectik Devs) built the Crisper app as a free app. This
			...
			Terms and Conditions, which is accessible at Crisper, unless otherwise
			...
			<br />
			<br />
			Your Name, Google Profile Picture and e-mail address when you register
			using Google Sign In.
			<br />
			This information allows us to help to provide you with a better user
			experience. WE DO NOT SHARE THIS INFORMATION WITH ANYONE/ NOR THIS
			INFORMATION IS VISIBLE TO ANYONE EXCEPT YOU.
			<br />
			<br />
			Analytics information:
			<br />
			<br />
			We use Firebase analytics tools to help us measure traffic and usage
			trends for the Service. <br />
			These tools collect information sent by your device or our Service,
			including the WORDS you've liked this assists us in improving the Service.
			...
			<br />
			Our free applications use advertising currently provided by Admob and
			anonymous statistical information is reported to them so they can see
			whether their adverts are effective. For more information about Admob :
			http://www.admob.com/
			<br />
			<br />
			Log Data
			...
			hesitate to contact us at eclectik.devs@gmail.com.
			<br />
		</div>
	);
}
